...
export interface ApiMySpecificCtMySpecificCt
  extends Struct.CollectionTypeSchema {
  collectionName: 'my_specific_cts';
  info: {
    displayName: 'MySpecificCT';
    pluralName: 'my-specific-cts';
    singularName: 'my-specific-ct';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::my-specific-ct.my-specific-ct'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface PluginMultiDomainDomain extends Struct.CollectionTypeSchema {
  collectionName: 'plugin_multi_tenant_domains';
  info: {
    displayName: 'Domain';
    pluralName: 'domains';
    singularName: 'domain';
  ...
  attributes: {
    ...
    damRootDirectory: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::multi-domain.domain'
    ...
    tokens: Schema.Attribute.Relation<'oneToMany', 'admin::api-token'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::my-specific-ct.my-specific-ct': ApiMySpecificCtMySpecificCt;
      'plugin::content-releases.release': PluginContentReleasesRelease;
      'plugin::content-releases.release-action': PluginContentReleasesReleaseAction;
      'plugin::i18n.locale': PluginI18NLocale;
      'plugin::multi-domain.domain': PluginMultiDomainDomain;
